...
public class BetaFunctionsTests
{
    ...
    public void LogGamma_KnownValues(UInt64 x, double expected)
    {
    ...
    public void LogBeta_MatchesScipy(UInt64 a, UInt64 b, double expected)
    {
    ...
    public void RegularizedIncompleteBeta_MatchesScipy(UInt64 a, UInt64 b, double x, double expected)
    {
    ...
    {
        Assert.Equal(0.0, BetaFunctions.RegularizedIncompleteBeta(2, 3, 0.0));
    }

    [Fact]
    public void RegularizedIncompleteBeta_XOne_ReturnsOne()
    {
        Assert.Equal(1.0, BetaFunctions.RegularizedIncompleteBeta(2, 3, 1.0));
    }
    ...
    public void RegularizedIncompleteBeta_InvalidArguments_Throws(UInt64 a, UInt64 b, double x)
    {
    ...
    public void InverseRegularizedIncompleteBeta_MatchesScipy(UInt64 a, UInt64 b, double p, double expected)
    {
    ...
    {
        Assert.Equal(0.0, BetaFunctions.InverseRegularizedIncompleteBeta(2, 3, 0.0));
    }

    [Fact]
    public void InverseRegularizedIncompleteBeta_POne_ReturnsOne()
    {
        Assert.Equal(1.0, BetaFunctions.InverseRegularizedIncompleteBeta(2, 3, 1.0));
    }
    ...
    [InlineData(1.0, 1.0, -0.1)]
    [InlineData(1.0, 1.0, 1.1)]
    public void InverseRegularizedIncompleteBeta_InvalidArguments_Throws(UInt64 a, UInt64 b, double p)
    {
